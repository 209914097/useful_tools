...
#查票
#常用三字码与站点对应关系
areatocode={"沈阳":"SBT","广州":"GZQ","上海":"SHH","北京":"BJP","南京":"NJH","昆山":"KSH","杭州":"HZH","桂林":"GLZ"}
# start1=input("请输入起始站:")
start1="北京"
#start1="北京"
...
leftTicketDTO.from_station="+start+"&leftTicketDTO.to_station="+to+"&purpose_codes=ADULT"
context = ssl._create_unverified_context()

# --------https://kyfw.12306.cn/otn/leftTicket/query?leftTicketDTO.train_date="+date+"&\leftTicketDTO.from_station="+start+"&leftTicketDTO.to_station="+to+"&purpose_codes=ADULT"
...
#-----------------"https://kyfw.12306.cn/otn/login/init#"登录部分-----------
...
# -----------------captcha-image?login_site=E&module=login&rand=sjrand-----下载验证码------
urllib.request.urlretrieve(yzmurl,"./12306_yzm.png")
# -----------------captcha-image?login_site=E&module=login&rand=sjrand-----------
...
print(allpicpos2)
#post验证码验证
# -----------------https://kyfw.12306.cn/passport/captcha/captcha-check------提交验证码-----
...
# -------------------------------------query?leftTicketDTO.train_date---------------
